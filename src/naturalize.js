...
// `persona.md` — NOT from hardcoded code here.
//
// TODO(persona-filler): if PRD §5.7's "filler from persona.md" is needed,
 ...
 * tokens mirror the list in persona.md. It never invents persona voice;
